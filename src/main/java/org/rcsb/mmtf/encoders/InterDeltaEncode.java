 ...
 *
 */
public class InterDeltaEncode implements Serializable, InterCoder {
	
	/**
	 * 
	 */
	private static final long serialVersionUID = 1393072243496506654L;
