 ...
 *
 */
public class TestIntraErrorEncode {
	...
	public void TestGetEncodedCoordinates() throws IOException {
		...
		List<Integer> v1outX = new ArrayList<Integer>(Arrays.asList(1,1,0,0,0));
		...
		List<Integer> v2outX = new ArrayList<Integer>(Arrays.asList(2,2,0,0,0));
		...
		IntraErrorEncode encoder = new IntraErrorEncode();
		//encoder.run(inArray);
