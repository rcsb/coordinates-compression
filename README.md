...
You can get the latest source code using git. Then you can execute an *install* goal with [Maven](http://maven.apache.org/guides/getting-started/index.html#What_is_Maven) to build the project.
```
...
mvn exec:java -Dexec.mainClass="org.rcsb.mmtf.analysis.RunTotalAnalysis" -Dexec.args="path1 path2"

path1: path to a Hadoop sequence file with the PDB structures in MMTF format
path2: path to the folder with results
